...
public class MyAllKeyBoardView extends KeyboardView {
    private Context  mContext;
    private Keyboard mKeyBoard;

    public MyAllKeyBoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public MyAllKeyBoardView(Context context, AttributeSet attrs, int defStyle) {
